...
class PaytmController extends Controller
{
    public function create(Request $request)
    {
        ...
        $input = $request->validate([
            'order_id' => ['required', 'string', Rule::unique('paytm_orders', 'order_id')->where('user_id', $userId)],
        ...
        $actionUrl = env('APP_URL') . '/paytm/request';
    ...
    public function request(Request $request)
    {
        ...
        $body = [
            ...
            'redirectionUrlSuccess' => env('PAYTM_REDIRECT_URL') . "?order_id={$input['order_id']}",
            'redirectionUrlFailure' => env('PAYTM_REDIRECT_URL') . "?order_id={$input['order_id']}"
        ];
