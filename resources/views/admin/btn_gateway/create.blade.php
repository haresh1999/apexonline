...
@section('title','Add Button Gateway')
...
<h3 class="mb-2 lh-sm">Add New Button Gateway</h3>
<p class="text-body-tertiary lead mb-2">Add New Button Payment Gateway Method to Explore Your Buttons Collect Payment.</p>
<div class="row g-4">
                ...
                <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-body mb-0">Add Button Gateway</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('bg.store') }}" method="post" autocomplete="off">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control no-arrow" type="url" name="url" id="url" value="{{ old('url') }}" />
                                @error('url')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
