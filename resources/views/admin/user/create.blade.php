...
<h3 class="mb-2 lh-sm">Add Company</h3>
<p class="text-body-tertiary lead mb-2">Create company for cooperate your business.</p>
<div class="row g-4">
                ...
                <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-body mb-0">Add New Company</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('company.store') }}" method="post">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control no-arrow" type="text" name="client_id" id="client_id" value="{{ old('client_id') }}" />
                                @error('client_id')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control no-arrow" type="text" name="client_secret" id="client_secret" value="{{ old('client_secret',str()->uuid()) }}" readonly />
                                @error('client_secret')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control no-arrow" type="text" name="sbx_client_id" id="sbx_client_id" value="{{ old('sbx_client_id') }}" />
                                @error('sbx_client_id')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control no-arrow" type="text" name="sbx_client_secret" id="sbx_client_secret" value="{{ old('sbx_client_secret',str()->uuid()) }}" readonly />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="whitelist_ip" id="whitelist_ip" placeholder="45.51.217.8, 12.43.38.103">{{old('whitelist_ip')}}</textarea>
                                @error('whitelist_ip')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <select class="form-control" name="default_gateway" id="default_gateway">
                                    ...
                                    <option @selected(old('default_gateway')==$pg) value="{{$pg}}">{{ucfirst($pg)}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control no-arrow" type="text" name="callback_secret" id="callback_secret" value="{{ old('callback_secret',str()->uuid()) }}" readonly />
