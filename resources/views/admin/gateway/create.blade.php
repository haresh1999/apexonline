...
<h3 class="mb-2 lh-sm">Add Gateway</h3>
<p class="text-body-tertiary lead mb-2">Create New Gateway to Explore Your Business.</p>
<div class="row g-4">
                ...
                <div class="card-header p-4 border-bottom bg-body">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-body mb-0">Add New Gateway</h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('pg.store') }}" method="post">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-12">
